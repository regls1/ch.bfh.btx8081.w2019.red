...
@Route
public class ExerciseDetailView3 extends VerticalLayout {
	...
	public ExerciseDetailView3() {
		...
		Exercise exercise = allExercises.get(2);
		...
		dlgExerciseDetail.setHeight("170px");
