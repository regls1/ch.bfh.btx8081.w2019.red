...
@Route
public class ExerciseDetailView8 extends VerticalLayout {
	...
	public ExerciseDetailView8() {
		...
		Exercise exercise = allExercises.get(7);
		...
		dlgExerciseDetail.setHeight("150px");
